    ...
    exec = async (M, parsedArgs) => {
        if (!parsedArgs.text) {
            ...
            return void (await M.replyRaw({
                image: {
                    url: 'https://raw.githubusercontent.com/coderxsa/WABot/main/WA-BOT/cdn/images/logo.png'
                },
                ...
                contextInfo: {
                    externalAdReply: {
                        ...
                        body: '',
                        thumbnail: await this.client.util.fetchBuffer('https://raw.githubusercontent.com/coderxsa/WABot/main/WA-BOT/cdn/images/logo2.png'),
                        mediaType: 1,
                        mediaUrl: '',
                        sourceUrl: '',
